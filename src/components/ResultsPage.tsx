...
export default function ResultsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f5ead6] to-[#e8dcc4]">
      ...
      <section className="flex items-center justify-center px-6 pt-20 pb-12">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white/60 rounded-2xl p-8 mb-8 border-2 border-[#d4c4a8]">
            ...
            <p className="text-6xl font-bold text-[#7a6550]">{result.probability}%</p>
